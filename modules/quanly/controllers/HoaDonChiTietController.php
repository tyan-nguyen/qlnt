...
use app\modules\quanly\models\HoaDonChiTietSearch;
...
class HoaDonChiTietController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new HoaDonChiTiet",
                ...
                return [
                    ...
                    'title'=> "Create new HoaDonChiTiet",
                    'content'=>'<span class="text-success">Create HoaDonChiTiet success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-bs-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing HoaDonChiTiet model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing HoaDonChiTiet model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
